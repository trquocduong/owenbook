          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-success shadow-success text-center rounded-circle mt-2">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-warning shadow-warning text-center rounded-circle mt-2">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-center mt-2">
                      <span class="bg-danger p-2 text-light" style="border-radius: 100%">{{$need->quantity}}</span>
                    </td>
                    <td class="align-middle">
