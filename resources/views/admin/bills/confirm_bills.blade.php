...
<main class="main-content position-relative border-radius-lg" style="height: 800px">
  ...
  <div class="container-fluid py-4">
    ...
    <div class="tab-content" id="ex1-content">
      <div class="tab-pane fade {{ $currentTab == '1' ? 'show active' : '' }}" id="ex1-tabs-1" role="tabpanel"
        ...
        <div class="card">
          ...
          <div class="table-responsive">
            <table class="table align-items-center mb-0">
              <thead>
                <tr>
                  <th class="text-center text-secondary text-xxs font-weight-bolder opacity-7">STT
                  </th>
                  ...
                  <th class="text-center text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                    Tên</th>
                  <th class="text-center text-secondary text-xxs font-weight-bolder opacity-7">Trạng
                    thái</th>
                  <th class="text-center text-secondary text-xxs font-weight-bolder opacity-7">Đơn
                    ngày</th>
                  <th class="text-center text-secondary text-xxs font-weight-bolder opacity-7">Thao
                    tác</th>
                </tr>
              </thead>
              @php
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex px-2 py-1">
                      <div>
                        <div><a href="/showbill/{{$needs->id}}">{{$needs->id_bill}}</a>
                        </div>
                      </div>
                  ...
                  <td class="text-center">
                    <form action="{{ route('bills.approve', $needs->id) }}" method="POST"
                    ...
                    <form action="{{ route('bills.cancel', $needs->id) }}" method="POST"
                      style="display: inline;">
                      @csrf
                      @method('DELETE')
      ...
      <div class="tab-pane fade {{ $currentTab == '2' ? 'show active' : '' }}" id="ex1-tabs-2" role="tabpanel"
      ...
      <div class="tab-pane fade {{ $currentTab == '3' ? 'show active' : '' }}" id="ex1-tabs-3" role="tabpanel"
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle">
                    <form action="{{ route('bills.destroy', $needs->id) }}" method="POST"
                      style="display: inline;">
                      @csrf
                      @method('DELETE')
                      <button type="submit" class="btn btn-link text-danger px-3 mb-0"
                        onclick="return confirm('Bạn có chắc chắn muốn xoá đơn hàng này?');">
      ...
      <div class="tab-pane fade {{ $currentTab == '4' ? 'show active' : '' }}" id="ex1-tabs-4" role="tabpanel"
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex px-2 py-1">
                      <div>
                        <div><a href="/showbill/{{$needs->id}}">
                            {{ Str::limit($needs->id_bill, 8)}}</a>
